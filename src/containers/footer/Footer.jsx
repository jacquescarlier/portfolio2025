    ...
    <>
      <footer>
        <ul className="socialMediaLinks">
          ...
          <li><a href="https://link4ne1.netlify.app/" target="_blank" rel="noopener" title="mon site de liens"> <img src="./images/pinguoin.png" alt="logo linkedin" aria-label="liens vers mon site de liens" /> </a></li>
